...
const profile = {
    ...
    eeoc: { veteran_status: { answer: "Not a protected veteran", form_options: ["I am not a protected veteran"] } },
    application_answers: {},
    Q_and_A: {},
};
...
assert.deepEqual(plan.summary, { total: 7, ready: 4, needsReview: 2, skipped: 1 });
