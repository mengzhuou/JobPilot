...
const documents = {
    ...
    privacy: {
        ...
        sections: [
            ...
            ["Chrome extension", "The optional JobPilot Chrome extension scans visible application field labels, types, choices, and current completion state so it can prepare an autofill preview. It stores a revocable connection token and server address in Chrome extension storage, but does not store your Google password or the JobPilot server’s API keys. It does not overwrite completed fields or submit applications."],
            ["Optional AI assistance", "JobPilot does not send application fields to OpenAI automatically. If you explicitly generate suggestions or ask AI to improve an answer, JobPilot sends unresolved field labels and choices, relevant job information, your Profile work history, extracted résumé text, cached public portfolio text, and relevant answers you previously reviewed. Résumé text is extracted once per uploaded file and public portfolio text is fetched once per saved URL. LinkedIn is not scraped. Suggestions remain in the extension review screen until you explicitly apply them. Accepted answers and story context are saved for similar future questions."],
...
export default function LegalPage({ type }) {
    ...
    return <div className="legal-page">
        ...
        <main className="legal-document">
            ...
            <p className="legal-date">Last updated: <time dateTime="2026-09-19">September 19, 2026</time></p>
