...
const documents = {
    ...
    privacy: {
        ...
        sections: [
            ...
            ["Optional AI assistance", "JobPilot does not send application fields to OpenAI automatically. If you explicitly request AI suggestions, JobPilot sends the unresolved field labels and choices, relevant job information, and the Profile and résumé metadata needed to draft grounded answers. Suggestions remain subject to your review before they can be entered into an application."],
